Regla 1. Utilizar el selector de tipo "body" para cambiar el tipo de fuente del body a "font-family: 'Quicksand', sans-serif" y utilizar el selector universal para poner color gris todo el fondo de la pàgina
